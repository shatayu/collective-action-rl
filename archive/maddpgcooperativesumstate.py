...
policy_means = open('maddpgcooperativesumstate_policymeans.txt', 'a')
full_results = open('maddpgcooperativesumstate_results.txt', 'a')
checkpoint_paths = open('maddpgcooperativesumstate_checkpoints.txt', 'a')
