...
class CollectiveActionEnv(MultiAgentEnv):
    ...
    def find_rewards(self, action_dict):
        ...
        return self._make_dict(total_reward_array)
...
policy_means = open('maddpgcooperativegamestate_policymeans.txt', 'a')
full_results = open('maddpgcooperativegamestate_results.txt', 'a')
checkpoint_paths = open('maddpgcooperativegamestate_checkpoints.txt', 'a')
