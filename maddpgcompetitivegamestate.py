...
policy_means = open('maddpgcompetitivegamestate_policymeans.txt', 'a')
full_results = open('maddpgcompetitivegamestate_results.txt', 'a')
checkpoint_paths = open('maddpgcompetitivegamestate_checkpoints.txt', 'a')
